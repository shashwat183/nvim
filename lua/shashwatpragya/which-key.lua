...
local mappings = {
	["a"] = { "<cmd>Alpha<cr>", "Start Dashboard" },
	["b"] = {
		"<cmd>lua require('telescope.builtin').buffers(require('telescope.themes').get_dropdown{previewer = false})<cr>",
		"Buffers",
	},
	-- ["e"] = { "<cmd>NvimTreeToggle<cr>", "Explorer" },
	["C"] = { "<cmd>lua print(vim.fn.expand('%:p'))<cr>", "Print Path" },
	["o"] = { "<cmd>SymbolsOutline<cr>", "Outline" },
	-- ["w"] = { "<cmd>w!<CR>", "Save" },
	["Q"] = { ":q<CR>", "Quit" },
	["c"] = { "<cmd>bp | sp | bn | bd!<CR>", "Close Buffer" },
	["f"] = {
		"<cmd>lua require('telescope.builtin').find_files({path_display={'absolute'}, layout='horizontal', hidden=true, no_ignore=true})<cr>",
	...
	l = {
		...
		c = {
			...
			d = { "<cmd>lua vim.lsp.codelens.display()<cr>", "CodeLens Display" },
		},
